...
char *NP_GetMIMEDescription(void) {
  return (char *)"application/x-npapi-file-io::Sympathy Filesystem Reader Plugin;";
}

NPError NP_GetValue(void *instance, NPPVariable variable, void *value) {
  switch(variable) {
    case NPPVpluginNameString: {
      *((char **)value) = (char *)"Sympathy Filesystem Plugin";
      break;
    }
    case NPPVpluginDescriptionString: {
      *((char **)value) = (char *)"Plugin to allow Sympathy Editor to read and write files on your system.";
      break;
    }
    default: {
